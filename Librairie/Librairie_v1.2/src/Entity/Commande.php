...
class Commande
{
    ...
    /**
     * Une Commande peut contenir plusieurs exemplaires d'un livre
     * @ManyToMany(targetEntity="Exemplaire")
     * @JoinTable(name="LigneCommande",
     *      joinColumns={@ORM\JoinColumn(name="cmd_id", referencedColumnName="id")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="exemplaire_id", referencedColumnName="id")}
     *      )
     */
    private $exemplaires;
